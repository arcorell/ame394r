...
function loadTree3(){
 ...
 var treeParent = theHTMLTree.tree('getNodeById', bodyID) //parent of tree will be used as a starting point, function found in jqTree library
//start of A5 work
function getDFOrder()
{
  var curr;
  ...
  var DFOrder = [];
  var children = treeParent.children[];
...
function getBFOrder()
{
  ...
  while (curr = stack[stackItem++]) {
      //makes current a new stack object with a node and depth. 
      depth = curr.depth;
      curr = curr.node;
